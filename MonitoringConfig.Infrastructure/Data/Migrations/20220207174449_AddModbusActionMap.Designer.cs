            ...
            modelBuilder.Entity("MonitoringConfig.Infrastructure.Data.Model.ModbusActionMap", b =>
                {
                    b.HasOne("MonitoringConfig.Infrastructure.Data.Model.FacilityAction", "FacilityAction")
                        ...
                        .HasForeignKey("MonitoringConfig.Infrastructure.Data.Model.ModbusActionMap", "FacilityActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MonitoringConfig.Infrastructure.Data.Model.MonitoringBox", "MonitoringBox")
                        .WithOne("ModbusActionMap")
                        .HasForeignKey("MonitoringConfig.Infrastructure.Data.Model.ModbusActionMap", "MonitoringBoxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                            ...
                            b1.OwnsOne("MonitoringConfig.Infrastructure.Data.Model.ModbusConfig", "ModbusConfig", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("MonitoringConfig.Infrastructure.Data.Model.ChannelRegisterMapping", "ChannelMapping", b3 =>
                                        {
                                    ...
                                    b2.OwnsOne("MonitoringConfig.Infrastructure.Data.Model.ModbusAddress", "ModbusAddress", b3 =>
                                        {
                                            b3.Property<int>("ModbusConfigNetworkConfigurationModbusDeviceId")
                                                .HasColumnType("int");
